        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdealSoil = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MedicalBenefits = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlantGuideSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlantGuideSteps_PlantInfos_PlantInfoId",
